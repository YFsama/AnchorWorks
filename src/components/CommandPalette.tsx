...
export function CommandPalette({
  ...
  const commands: Command[] = useMemo(() => [
    ...
    { id: 'color.saturate',    label: t('Saturate…'),          category: t('Arrange'), keywords: 'saturate saturation vivid desaturate edit colors', icon: Palette, run: () => setModal('showSaturate', true) },
    { id: 'color.hue',         label: t('Adjust Hue…'),        category: t('Arrange'), keywords: 'hue shift rotate colour wheel recolor edit colors', icon: Palette, run: () => setModal('showHue', true) },
    { id: 'color.brightness',  label: t('Adjust Brightness…'), category: t('Arrange'), keywords: 'brightness lighten darken lightness value edit colors', icon: Palette, run: () => setModal('showBrightness', true) },
    ...
    { id: 'cut.grommets',     label: t('Banner Grommets…'), category: t('Arrange'), keywords: 'grommet eyelet banner hole finishing corner edge', icon: Wand2, run: () => setModal('showGrommets', true) },
    ...
    { id: 'view.rulers', label: t('Show Rulers'), category: t('View'), keywords: 'ruler rulers toggle show hide measure', icon: Grid3X3, run: () => { const s = useEditor.getState(); s.setRulersVisible(!s.rulersVisible); } },
    { id: 'view.guides', label: t('Show Guides'), category: t('View'), shortcut: 'Ctrl+;', keywords: 'guide guides toggle show hide ruler', icon: Grid3X3, run: () => { const s = useEditor.getState(); s.setGuidesVisible(!s.guidesVisible); } },
