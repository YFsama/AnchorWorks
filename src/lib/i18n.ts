...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'Apply swatch': { en: 'Apply swatch', zh: '应用色板' },
  'Remove swatch': { en: 'Remove swatch', zh: '移除色板' },
  'Swatch added': { en: 'Swatch added', zh: '已添加色板' },
  'Already in swatches.': { en: 'Already in swatches.', zh: '色板中已存在。' },
  'Add current fill as swatch': { en: 'Add current fill as swatch', zh: '将当前填充加为色板' },
  'click to fill, Alt-click for stroke': { en: 'click to fill, Alt-click for stroke', zh: '点击填充，Alt+点击描边' },
