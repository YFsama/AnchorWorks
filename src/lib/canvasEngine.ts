...
export { deleteSelection, duplicateSelection, nudgeSelection, flipSelection, selectSame, lockSelection, unlockAll, hideSelection, showAll, makeGuidesFromSelection, selectInverse } from './selectionOps';
