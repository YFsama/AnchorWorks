...
export const BINDINGS: ShortcutBinding[] = [
  ...
  { id: 'path.averageAnchors',   label: 'Average Anchor Points', defaultCombo: 'Ctrl+Alt+J' },
  { id: 'object.isolation',      label: 'Isolation Mode',       defaultCombo: 'Ctrl+Alt+I' },
  ...
  { id: 'edit.pasteInFront',     label: 'Paste in Front',      defaultCombo: 'Ctrl+F' },
  { id: 'edit.pasteInBack',      label: 'Paste in Back',       defaultCombo: 'Ctrl+B' },
  ...
  { id: 'edit.compoundPath',     label: 'Make Compound Path',  defaultCombo: 'Ctrl+8' },
  { id: 'edit.releaseCompound',  label: 'Release Compound Path', defaultCombo: 'Ctrl+Alt+8' },
  ...
  { id: 'view.zoomSelection',    label: 'Zoom to Selection',   defaultCombo: 'Ctrl+Shift+2' },
  { id: 'view.toggleGuides',     label: 'Show / Hide Guides',  defaultCombo: 'Ctrl+;' },

  // -------- File --------
  { id: 'file.new',              label: 'New',                 defaultCombo: 'Ctrl+N' },
  { id: 'file.newFromTemplate',  label: 'New from Template…',   defaultCombo: 'Ctrl+Alt+N' },
  { id: 'file.openProject',      label: 'Open Project…',       defaultCombo: 'Ctrl+Alt+O' },
  { id: 'file.saveProject',      label: 'Save Project',        defaultCombo: 'Ctrl+Shift+S' },
  { id: 'file.saveProjectAs',    label: 'Save Project As…',    defaultCombo: 'Ctrl+Alt+Shift+P' },
  ...
  { id: 'file.importImage',      label: 'Import Image…',       defaultCombo: 'Ctrl+Alt+Shift+I' },
  { id: 'file.exportSvg',        label: 'Export SVG',          defaultCombo: 'Ctrl+S' },
  { id: 'file.print',            label: 'Print',               defaultCombo: 'Ctrl+P' },
  { id: 'file.tilePrint',        label: 'Tile Print…',         defaultCombo: 'Ctrl+Alt+P' },
  ...
  // -------- Align / Distribute --------
  { id: 'align.left',            label: 'Align left',          defaultCombo: 'Alt+Shift+ArrowLeft' },
  { id: 'align.centerH',         label: 'Align center horizontally', defaultCombo: 'Alt+Shift+H' },
  { id: 'align.right',           label: 'Align right',         defaultCombo: 'Alt+Shift+ArrowRight' },
  { id: 'align.top',             label: 'Align top',           defaultCombo: 'Alt+Shift+ArrowUp' },
  { id: 'align.centerV',         label: 'Align center vertically', defaultCombo: 'Alt+Shift+V' },
  { id: 'align.bottom',          label: 'Align bottom',        defaultCombo: 'Alt+Shift+ArrowDown' },
  { id: 'distribute.horizontal', label: 'Distribute horizontally (equal spacing)', defaultCombo: 'Alt+Shift+X' },
  { id: 'distribute.vertical',   label: 'Distribute vertically (equal spacing)', defaultCombo: 'Alt+Shift+Y' },

  // -------- Selection --------
  { id: 'edit.selectAll',        label: 'Select All',          defaultCombo: 'Ctrl+A' },
  { id: 'edit.deselectAll',      label: 'Deselect All',        defaultCombo: 'Ctrl+Shift+A' },
  { id: 'edit.selectInverse',    label: 'Select Inverse',      defaultCombo: 'Ctrl+Shift+I' },
  ...
  { id: 'edit.lockSelection',    label: 'Lock Selection',      defaultCombo: 'Ctrl+2' },
  { id: 'edit.unlockAll',        label: 'Unlock All',          defaultCombo: 'Ctrl+Alt+2' },
  { id: 'edit.hideSelection',    label: 'Hide Selection',      defaultCombo: 'Ctrl+3' },
  { id: 'edit.showAll',          label: 'Show All',            defaultCombo: 'Ctrl+Alt+3' },
  { id: 'text.createOutlines',   label: 'Create Outlines',     defaultCombo: 'Ctrl+Shift+O' },
  { id: 'text.splitLetters',     label: 'Break Text into Letters', defaultCombo: 'Ctrl+Alt+L' },
  { id: 'text.splitLines',       label: 'Break Text into Lines', defaultCombo: 'Ctrl+Alt+Shift+L' },
  { id: 'text.arcUp',            label: 'Text on Arc (Up)',    defaultCombo: 'Ctrl+Alt+A' },
  { id: 'text.arcDown',          label: 'Text on Arc (Down)',  defaultCombo: 'Ctrl+Alt+Shift+A' },
  { id: 'text.caseUpper',        label: 'UPPERCASE',            defaultCombo: 'Ctrl+Alt+U' },
  { id: 'text.caseLower',        label: 'lowercase',            defaultCombo: 'Ctrl+Alt+Shift+U' },
  { id: 'text.caseTitle',        label: 'Title Case',           defaultCombo: 'Ctrl+Alt+Shift+T' },
  { id: 'text.caseSentence',     label: 'Sentence case',        defaultCombo: 'Ctrl+Alt+Shift+S' },
  { id: 'text.smartPunctuation', label: 'Smart Punctuation',    defaultCombo: 'Ctrl+Alt+Q' },
  { id: 'text.singleLine',       label: 'Single-line Text…',   defaultCombo: 'Ctrl+Alt+T' },
  { id: 'text.findReplace',      label: 'Find & Replace…',     defaultCombo: 'Ctrl+Alt+F' },
  { id: 'text.variableData',     label: 'Variable Data…',      defaultCombo: 'Ctrl+Alt+V' },
  ...
  { id: 'text.trackingUp',       label: 'Increase Tracking',   defaultCombo: 'Alt+ArrowRight' },
  { id: 'text.trackingDown',     label: 'Decrease Tracking',   defaultCombo: 'Alt+ArrowLeft' },
  { id: 'text.leadingUp',        label: 'Increase Leading',    defaultCombo: 'Alt+ArrowUp' },
  { id: 'text.leadingDown',      label: 'Decrease Leading',    defaultCombo: 'Alt+ArrowDown' },
  ...
  { id: 'edit.defaultColors',    label: 'Default Fill / Stroke', defaultCombo: 'D' },
  { id: 'appearance.noFill',     label: 'No Fill',              defaultCombo: 'Ctrl+Alt+X' },
  { id: 'appearance.noStroke',   label: 'No Stroke',            defaultCombo: 'Ctrl+Alt+Shift+X' },
