...
interface EditorState {
  ...
  showOutline: boolean;
  showRecolor: boolean;
  showVariableData: boolean;
  showRhinestone: boolean;
  showSimplify: boolean;
  showTransform: boolean;
  showRoundCorners: boolean;
  showOffsetPath: boolean;
  setModal: (k: 'showPlotter' | 'showPrint' | 'showDocSettings' | 'showTemplates' | 'showShortcuts' | 'showCommandPalette' | 'showHelpCenter' | 'showRepeat' | 'showPreferences' | 'showKeymapEditor' | 'showCutContour' | 'showTilePrint' | 'showOutline' | 'showRecolor' | 'showVariableData' | 'showRhinestone' | 'showSimplify' | 'showTransform' | 'showRoundCorners' | 'showOffsetPath', v: boolean) => void;
